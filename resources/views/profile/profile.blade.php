...
<body class="g-sidenav-show bg-gray-200">
      <div class="container-fluid px-2 px-md-4">
        <div class="page-header min-height-300 border-radius-xl mt-4 px-2 py-2" style="background-image: url('https://images.unsplash.com/photo-1531512073830-ba890ca4eba2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80');">
            <h1 class="container" style="align-items: center; justify-content: center; background-color: transparent; color: #f2f2f2">INI ADALAH HALAMAN PROFIL PENGGUNA</h1>
